...
class Config {
  ...
  static Widget toWidget(BuildContext context, _Builder widget) {
    ...
    return Chip(
      ...
      avatar: DynamicWidgetBuilder.buildWidget(
          DynamicWidgetConfig.fromJson(props?.avatar ?? {}),
          context: context,
          event: widget.event) ??
          SizedBox(),
      label: DynamicWidgetBuilder.buildWidget(
          DynamicWidgetConfig.fromJson(props?.label ?? {}),
          context: context,
          event: widget.event) ??
          SizedBox(),
  ...
  static Map? toJson(Widget? widget, String widgetName,
    ...
    return {
      ...
      'deleteIcon': DynamicWidgetBuilder.transformMap(
          realWidget.deleteIcon, buildContext),
      'xVar': {
        'labelStyle': DynamicWidgetUtils.transform(realWidget.labelStyle),
        'labelPadding': DynamicWidgetUtils.transform(
            realWidget.labelPadding as EdgeInsets?),
        'deleteIconColor':
        DynamicWidgetUtils.transform(realWidget.deleteIconColor),
        ...
        'backgroundColor':
        DynamicWidgetUtils.transform(realWidget.backgroundColor),
        'padding':
        DynamicWidgetUtils.transform(realWidget.padding as EdgeInsets?),
      },
